<template>
    <div class="flex flex-col lg:flex-row gap-5 bg-slate-100 p-5 lg:p-10 lg:rounded-3xl max-w-7xl lg:mx-auto my-10 w-screen">
        ...
        <div class="flex flex-col lg:flex-row flex-wrap w-full  overflow-hidden  overflow-x-scroll  gap-4 bg-white p-5 rounded-3xl snap-x text-slate-700"
            id="container">
            <transition-group name="slide-fade">
                <div class="lg:basis-[200px] lg:min-h-[200px] bg-gray-100 rounded-3xl p-5 pb-6 flex flex-col items-center justify-between relative lg:flex-shrink-0 snap-center"
